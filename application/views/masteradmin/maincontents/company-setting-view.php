<h4><i class="fa fa-plus-square-o"></i> Company Details </h4>
<hr class="style5">
<span style="color:#00CC00;">
<?php if($this->session->flashdata('success_message')) { echo $this->session->flashdata('success_message'); } ?>
</span>
<form class="form-horizontal" method="post" action="<?php echo base_url();?>masteradmin/user/company_setting/">
<?php
	if($row)
	{
...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">      
      <textarea name="company_address" id="company_address" class="form-control" rows="7">
